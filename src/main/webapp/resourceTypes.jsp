...
<h3 class="col-lg-4 col-lg-offset-4">ResourceTypes list <button type="button" class="btn btn-primary btn-circle btn-lg createResourceType"><i class="glyphicon glyphicon-plus"></i></button></h3>
