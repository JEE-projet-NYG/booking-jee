...
<h3 class="col-lg-4 col-lg-offset-4">Resources list <button type="button" class="btn btn-primary btn-circle btn-lg createResource"><i class="glyphicon glyphicon-plus"></i></button></h3>
